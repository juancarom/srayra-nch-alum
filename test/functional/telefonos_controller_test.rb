...
class TelefonosControllerTest < ActionController::TestCase
  ...
  test "should create telefono" do
    assert_difference('Telefono.count') do
      post :create, telefono: { codigo_de_area: @telefono.codigo_de_area, numero: @telefono.numero, tipo_de_telefono_id: @telefono.tipo_de_telefono_id }
    end
  ...
  test "should update telefono" do
    put :update, id: @telefono, telefono: { codigo_de_area: @telefono.codigo_de_area, numero: @telefono.numero, tipo_de_telefono_id: @telefono.tipo_de_telefono_id }
    assert_redirected_to telefono_path(assigns(:telefono))
  end
